navigator &&
  ...
  navigator.connection.addEventListener &&
    navigator.connection.addEventListener("change", ({ target: n }) => (window.networkInfo = n)));
      ...
      e.forEach((e) => {
        if (e.isIntersecting) {
          ...
          r.hasAttribute("data-lazybg") &&
            (t.classList.add(...r.classList), t.classList.remove("d-none"), r.remove(), a.unobserve(t));
        }
      });
    },
    { rootMargin: "150px" }
...
_trfd.push({
  ap: "IPv2",
  websiteId: "3d18f8ee-1861-4a40-9c71-1a20655d1baa",
  "tccl.baseHost": "secureserver.net",
  pd: "2024-07-09T16:59:26.967Z",
  "meta.numWidgets": 8,
  "meta.theme": "layout28",
          ...
          const e = ((t, s, { name: e, vars: r }) => ({ id: p(e, t), vars: r, name: e, entry: t, versions: s }))(
            ...
            s.reduce((t, { v: s, u: e = null, f: r = null, s: i = [], d: n = [] }) => {
              ...
              return (
                w(s).forEach((s) => {
                  t.push(
                    ((t, { version: s }) => ({ version: s, statics: [], dynamics: [], ...t }))(
    ...
    S(t, e) {
      return new s((t, s) => {
        (e.resolve = t),
          (e.reject = s),
          a.head.appendChild(
            n.assign(a.createElement("script"), { crossOrigin: "Anonymous", onerror: s, src: e.url, instance: this })
          );
      });
    }
    async D(t) {
